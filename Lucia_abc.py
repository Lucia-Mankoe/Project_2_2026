...
# This function calculates, sorts and classifies the inventory items.
def classify_inventory(skus):
    ...
    # This function assigns each inventory item to A, B or C using the 70% and 90% thresholds.
    ...
    # This prints the classification report for all inventory items.
    for item in skus_sorted:
